...
### 4. A Zero Knowledge Proof framework for Cardano based on Hydra and ZK-SNARKS

- Presenter: Agustín Salinas
- [Ideascale URL](https://cardano.ideascale.com/c/idea/105211)
- [Youtube URL]()
- [Presentation slides](https://docs.google.com/presentation/d/1QBPsW5SnCRha-6GV4hL0cdoj59ltL6cpBSyXYYg5It0)
...
### 6. The FUNINTEC's student Hubs: The cascade effect in the Project Catalyst and Cardano

- Presenter: jeancaguilar1@gmail.com
- [Ideascale URL](https://cardano.ideascale.com/c/idea/103904)
- [Youtube URL](https://youtu.be/wI3GbHIBnPA)
- [Presentation slides](https://youtu.be/D7qwGMzR-_M)
- Proposal summary: We will train 30 facilitators in the Cardano network and the catalyst project at FUNINTEC who will then cascade the knowledge to 120 university and high school students.

### 7. Scalable, Authenticated, Traceable Carbon Credit on Cardano

- Presenter: Hien Mai
- [Ideascale URL](https://cardano.ideascale.com/c/idea/106444)
- [Youtube URL](https://youtu.be/HukV2-tlkDM)
- [Presentation slides](https://docs.google.com/presentation/d/1HmwK8A3UEPfPW5KdwINxWRLkG_XyD9hegQNpE1NixgI)
...
### 8. Community Health insights to build unstoppable Cardano communities
...
### 9. NZTwork  (Net Zero Token Network): Revolutionizing Carbon Credit Creation

- Presenter: Xuezhi Hu or Phillip Kopp
- [Ideascale URL](https://cardano.ideascale.com/c/idea/102093)
- [Youtube URL]()
- [Presentation slides](https://docs.google.com/presentation/d/1yOr0DcS74OaAQW9pxld6ZqdAQ0CVZHYR)
- Proposal summary: NZTwork: Data miners collect IoT data and apply it to AI apps that help reduce carbon footprint through energy saving and solar, then monetize performance with rewards and NFTs as credits so users earn

### 10. Consenz: Community Discussions Integrations and Notifications
...
### 11. Web 3 Work Marketplace to connect Freelancer to Business on Cardano
...
### 12. Open source Marketplace “Opensea-like” for MIlkomeda usecases and Seedstars Galaxy

- Presenter: Tiziana Bombassei
- [Ideascale URL](https://cardano.ideascale.com/c/idea/106235)
- [Youtube URL]()
- [Presentation slides](https://docs.google.com/presentation/d/1YVwJ5isn3ok7-CfRUOCr7uWH9_0xRZ9c01V742PRpnk)
- Proposal summary: We propose to set up a launchpad and a marketplace for the Milkomeda chain to increase its adoption by new project holders and drive users toward the dapp thanks to facilitated UX. We will kickstart the adoption by onboarding a large-scale web2 player, Seedstars, who is working on entering the RealFi space by creating impact NFTs on the back of the impact of portfolio companies they'll be backing.

### 13. Develop a dynamic, visual dashboard leveraging Global Reporting Initiative (GRI) Standards to comprehensively measure, report, and illuminate the sustainability impact of Cardano-based projects, fostering transparency and credibility.
...
### 14. LATIN WOMEN building in CARDANO
...
### 15. Andromeda Way Agency (AWA) - Web 3.0, Cardano blockchain marketing & consulting agency
...
### 16. AgroTechnology Cardano: empowering Food Security & Sovereignty with Tokenization, Real-Time Traceability, Sovereign Identity, Quality Certificates NFTs, IoT Sensors, AI, Data Science, Precision Farming, Smart Contracts, and R&D
...
### 17. Catalyst School : Chapter Indonesia in collab with Gadjah Mada University (UGM)
...
### 18. Token Engineering on Cardano: Step-by-step tutorials to design economic mechanisms

- Presenter: Yohann Irani / Jack O'Brien
...
### 19. Unlocking the Power of cNFTs with Charity	James Ballester
